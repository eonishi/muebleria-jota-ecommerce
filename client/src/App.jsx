  ...
  return (
    ...
    <header>
        <div className="logo-container">
            <svg className="logo primario" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 375 375">
                <g>
                    <path
        ...
        <nav>
            <ul className="menu">
                ...
                <li><a href="../catalogo/catalogo.html">Productos</a></li>
    ...
    <main>
        <section className="hero">
            <div className="hero-content">
                ...
                <a href="../catalogo/catalogo.html" className="btn">Ver productos</a>
            </div>
        </section>
        
        <section className="section-box">
            <h2>Productos Destacados</h2>
            <div className="productos-container"></div>
        </section>
    </main>
          ...
          <ul className="footer-contacto">
           ...
           <li className="contact-item">
                ...
                <div className="contact-text">
                    ...
                    <a href="https://wa.me/541145678900" target="_blank" rel="noopener">11 4567-8900</a>
                </div>
            </li>
            <li className="contact-item">
