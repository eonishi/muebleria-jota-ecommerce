...
export default function PrecioTotal({ total, discount, className }) {
  ...
  const totalCheckout = stringifyPrice(total * (1 - discount / 100))
	...
	return (
		...
		>
			...
			<button
				type='button'
				className='w-full p-5 font-semibold text-base mt-5
          bg-accent text-neutral-50 focus:outline focus:outline-lime-900 hover:bg-lime-700 active:scale-97 transition-[background-color,scale]'
			>
				Proceder a Comprar
			</button>
		</article>
